...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
     ...
     *
     * @return UserInterface|null Result
     */
     ...
     *
     * @return RedirectResponse|\Symfony\Component\HttpFoundation\Response|null response
     *
     * @throws \Exception
     */
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey): RedirectResponse
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('record_index'));
    }

    /**
     * Return the URL to the login main.
     *
